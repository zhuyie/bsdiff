...
Technical documentation and reports for the bsdiff project.

| File | Topic | Date |
|------|-------|------|
| [perf_suffix_array_search.md](perf_suffix_array_search.md) | Optimizing the Suffix Array Search: Iterative Rewrite and LCP-Aware Binary Search | 2026-03-03 |
| [perf_comparison.md](perf_comparison.md) | Compatibility and Performance Comparison vs. Original bsdiff 4.3 | 2026-03-05 |
